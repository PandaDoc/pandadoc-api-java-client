...
public class CreateFromTemplateAndSend {
   ...
   public static DocumentCreateResponse createDocumentFromTemplate(DocumentsApi apiInstance) throws ApiException {
       ...
       PricingTableRequestOptions1 sectionOption = new PricingTableRequestOptions1()
               .qtyEditable(true)
               .optionalSelected(true)
               .optional(true);

       PricingTableRequestDataDiscount tableDataDiscount = new PricingTableRequestDataDiscount()
               .value(new BigDecimal("7.5"))
               .type("percent");

       PricingTableRequestData pricingTableData = new PricingTableRequestData()
               .name("Toy Panda")
               .description("Fluffy!")
