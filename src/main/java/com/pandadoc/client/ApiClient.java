...
import com.pandadoc.client.auth.Authentication;
import com.pandadoc.client.auth.HttpBasicAuth;
import com.pandadoc.client.auth.HttpBearerAuth;
import com.pandadoc.client.auth.ApiKeyAuth;
import com.pandadoc.client.auth.OAuth;
import com.pandadoc.client.auth.RetryingOAuth;
import com.pandadoc.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.pandadoc.com";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.pandadoc.com/oauth2/access_token";
    ...
    private void init() {
        ...
        setUserAgent("pandadoc_java_client/6.1.0");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pandadoc.com
