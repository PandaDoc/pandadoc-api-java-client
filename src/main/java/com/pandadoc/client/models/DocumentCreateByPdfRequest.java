...
public class DocumentCreateByPdfRequest {
  ...
  **/
  ...
  public DocumentCreateByPdfRequest parseFormFields(Boolean parseFormFields) {
  ...
  **/
  ...
  public DocumentCreateByPdfRequest name(String name) {
  ...
  **/
  ...
  public DocumentCreateByPdfRequest tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public DocumentCreateByPdfRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public DocumentCreateByPdfRequest fields(Object fields) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"Like\":{\"value\":true},\"Delivery\":{\"value\":\"Same Day Delivery\"},\"Date\":{\"value\":\"2019-12-31T00:00:00.000Z\"}}", value = "If you are creating a document from a PDF with field tags, you can pass a list of the fields you'd like to pre-fill in the document. If you are creating a document from a PDF with form fields, list all the fields and provide the `role` parameter so that the fields are assigned to document recipients. You can provide empty value for the field so that it's not pre-filled: \"value\": \"\". ")
  ...
  public DocumentCreateByPdfRequest metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DocumentCreateByPdfRequest documentCreateByPdfRequest = (DocumentCreateByPdfRequest) o;
    return Objects.equals(this.url, documentCreateByPdfRequest.url) &&
        Objects.equals(this.recipients, documentCreateByPdfRequest.recipients) &&
        Objects.equals(this.parseFormFields, documentCreateByPdfRequest.parseFormFields) &&
        Objects.equals(this.name, documentCreateByPdfRequest.name) &&
        Objects.equals(this.tags, documentCreateByPdfRequest.tags) &&
        Objects.equals(this.fields, documentCreateByPdfRequest.fields) &&
        Objects.equals(this.metadata, documentCreateByPdfRequest.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, recipients, parseFormFields, name, tags, fields, metadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentCreateByPdfRequest {\n");
